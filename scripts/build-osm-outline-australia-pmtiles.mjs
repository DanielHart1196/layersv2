...
const OUTLINE_TARGET = path.join(PUBLIC_DIR, "osm-outline-australia.pmtiles");
...
runOgr2ogr([
  ...
  "coastlines",
  "-dsco",
  "NAME=OSM Coastlines Australia Test",
  "-dsco",
  "DESCRIPTION=Australia-only OSM coastlines for atlas-product outline fidelity testing",
  "-dsco",
  "MINZOOM=0",
  "-dsco",
  "MAXZOOM=14",
